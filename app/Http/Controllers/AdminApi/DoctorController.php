...
class DoctorController extends BaseController
{
    ...
    public function index(Request $request){
        ...
        $list['data'] = $this->doctorService->selectDoctor($where,$orderName,$orderSort,$offset,$limit,'deptSort','DESC');
        $list['iTotalDisplayRecords'] = $this->doctorService->getDoctorCount($where);
    ...
    public function update($id,Request $request){
        ...
        $form_data = $request->except(['_token', '_method']);
        //创建管理员
        $result = $this->doctorService->updateDoctor($id,$form_data);

        //返回响应
        return $this->tool->response($result, 'admin/doctor');
