...
<div>
 <script id="editor" type="text/plain" name="content" style="width:1024px;;height:300px;margin:0px 19% 0px 19%;"><?php if(isset($info['content'])){echo $info['content'];}else{echo '';}?> </script>
</div>
{{--<div id="btns">
    <div>
